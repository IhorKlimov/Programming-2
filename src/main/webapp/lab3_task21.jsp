...
<div style="font-weight: bold; font-size: 30px">3 * (Math.log(a / b) + Math.sqrt(Math.cos(c) + Math.pow(Math.E, d)))
</div>
...
<form action="lab3_task19.jsp" method="GET" style="margin-top: 20px;">
    ...
    <table style="width: 100%; ">
        ...
        <tr>
            ...
            <td><%=3 * (Math.log(a / b) + Math.sqrt(Math.cos(c) + Math.pow(Math.E, d)))%>
            </td>
        </tr>
        <%
                        }
